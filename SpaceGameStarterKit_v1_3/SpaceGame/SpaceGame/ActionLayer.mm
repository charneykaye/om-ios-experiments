...
- (void)spawnShip {
    ...
    _ship = [[[GameObject alloc] initWithSpriteFrameName:@"SpaceFlier_sm_1.png" world:_world shapeName:@"SpaceFlier_sm_1" maxHp:10 healthBarType:HealthBarTypeGreen] autorelease];
...
- (void)setupBoss {
    _boss = [[[BossShip alloc] initWithWorld:_world layer:self] autorelease];
    _boss.visible = NO;
...
- (void)accelerometer:(UIAccelerometer *)accelerometer 
    ...
    NSLog(@"acceleration.x: %f, accelX: %f, rollingX: %f, accelDiffX: %f, accelFractionX: %f, pointsPerSecX: %f", 
          acceleration.x, accelX, rollingX, accelDiffX, accelFractionX, pointsPerSecX);
